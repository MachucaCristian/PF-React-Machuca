    ...
    return (
        <>
            ...
            <form onSubmit={chekOut} ref={datosFormulario}>
                ...
                <div className="mb-3">
                    <label htmlFor="email" className="form-label text-dark">Repetir Email </label>
                    <input type="repetiremail" className="form-control" name="repetiremail"  />
                    
                </div>
                <div className="mb-3">
                    <label htmlFor="direccion" className="form-label text-dark">Direccion</label>
                    <input type="direccion" className="form-control" name="direccion"  />
                    
                </div>
                <div className="mb-3">
                    <label htmlFor="telefono" className="form-label text-dark">Telefono</label>
                ...
                <Link className="btn btn-dark" to={"/confirmacionPedido"}>Confirmar Pedido</Link>
